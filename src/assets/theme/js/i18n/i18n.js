...
(function(root) {
    ...
    postMissing: function(lng, ns, key, defaultValue, lngs) {
      ...
      if (o.sendMissingTo === 'fallback' && o.fallbackLng[0] !== false) {
        ...
        for (var i = 0, l = lngs.length; i < l; i++) {
          urls.push({
            lng: lngs[i],
            url: applyReplacement(o.resPostPath, { lng: lngs[i], ns: ns })
          });
        }
      }
      ...
      getItem: function(key, value) {
        if (window.localStorage) {
          try {
            ...
            f.log(
              'failed to get value for key "' + key + '" from localStorage.'
            );
            return undefined;
          }
        }
  ...
  function applyReplacement(str, replacementHash, nestedKey, options) {
    ...
    var hash =
      replacementHash.replace && typeof replacementHash.replace === 'object'
    ...
    return str.replace(replacementRegex, function(
      wholeMatch,
      keyMatch,
      htmlMatched
    ) {
  ...
  function _find(key, options) {
    ...
    if (needsPlural(options, lngs[0])) {
      ...
      optionWithoutCount._origLng =
        optionWithoutCount._origLng || optionWithoutCount.lng || lngs[0];
    ...
    if (needsIndefiniteArticle(options)) {
      ...
      var indefiniteKey =
        ...
        nsseparator +
        key +
        ((options.count && !needsPlural(options, lngs[0])) || !options.count
          ? o.indefiniteSuffix
          : '');
